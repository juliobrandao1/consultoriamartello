...
<div id="slidebanner">
    ...
    <style>
        ...
        */
        ...
        .jssorb01 .av { background-color: gold; }
        ...
        */
        ...
        .jssora05l.jssora05lds { background-position: -10px -40px; opacity: .0; pointer-events: none; }
        .jssora05r.jssora05rds { background-position: -70px -40px; opacity: .0; pointer-events: none; }
    ...
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1000px; height: 220px; overflow: hidden; visibility: hidden;">
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 1000px; height: 300px; overflow: hidden;">
            <div data-p="112.50">
                <img data-u="" src="banner01.jpg" />
		
                
            </div>
            <a data-u="any" href="http://www.jssor.com" style="display:none">Banner Slider</a>
            <div data-p="112.50" style="display: none;">
                <img data-u="thumbimage" src="banner02.jpg" />
		
               
            </div>
	   <a data-u="any" href="http://www.jssor.com" style="display:none">Banner Slider</a>
            <div data-p="112.50" style="display: none;">
                <img data-u="thumbimage" src="banner03.jpg" />
